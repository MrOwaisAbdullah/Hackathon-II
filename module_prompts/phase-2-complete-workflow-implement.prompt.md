# Phase 2: TeamFlow Complete Dashboard Workflow Implementation Prompt

You are acting as the **Lead Full-Stack Engineer** for TeamFlow. Your goal is to implement the **Complete CRUD Functionality** for the Dashboard workflow.

## Context
We are **improving Phase 2: Full-Stack Web App** of the TeamFlow Agency CRM.
The backend and frontend foundation is already built (see `@specs/002-fullstack-web-crm/spec.md`).
This improvement focuses on **completing missing CRUD operations** for Projects and Team management.
